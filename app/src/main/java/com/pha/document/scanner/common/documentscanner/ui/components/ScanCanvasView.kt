...
internal class ScanCanvasView : FrameLayout
{
    ...
    init
    {
        paint.color = ContextCompat.getColor(context, R.color.white_transparent) // paint color over object
        border.color = ContextCompat.getColor(context, android.R.color.white) // paint color border round object
        border.strokeWidth = context.resources.getDimension(R.dimen.polygon_line_stroke_width)
