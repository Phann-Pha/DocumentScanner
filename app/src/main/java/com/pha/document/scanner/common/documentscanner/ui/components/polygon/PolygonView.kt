package com.pha.document.scanner.common.documentscanner.ui.components.polygon
...
) : FrameLayout(context, attrs, defStyleAttr)
{
    ...
    private var pointPadding = resources.getDimension(R.dimen.point_padding).toInt()
    ...
    init
    {
        ...
        paint.strokeWidth = context.resources.getDimension(R.dimen.polygon_line_stroke_width)
